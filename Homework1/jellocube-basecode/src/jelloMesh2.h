#ifndef JelloMesh2_H_
#define JelloMesh2_H_
...
public:
    ...
    // Update our JelloMesh2 (handles collisions and forces)
    ...
    // Set/Get our JelloMesh2 resolution
    ...
    // Set/Get our JelloMesh2 size (in world coordinates)
...
protected:
    ...
    public:
        ...
        FaceMesh(const JelloMesh2& m, Face f);
        void Draw(const JelloMesh2& m);
        void DrawNormals(const JelloMesh2& m);

        void CalcDistToEye(const JelloMesh2& m, const vec3& eyePos);
