#ifndef JelloMesh3_H_
#define JelloMesh3_H_
...
public:
    ...
    // Update our JelloMesh3 (handles collisions and forces)
    ...
    // Set/Get our JelloMesh3 resolution
    ...
    // Set/Get our JelloMesh3 size (in world coordinates)
...
protected:
    ...
    public:
        ...
        FaceMesh(const JelloMesh3& m, Face f);
        void Draw(const JelloMesh3& m);
        void DrawNormals(const JelloMesh3& m);

        void CalcDistToEye(const JelloMesh3& m, const vec3& eyePos);
